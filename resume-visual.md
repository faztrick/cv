...
- Architecture & MVVM: Modular Flutter, Node.js, and WPF ecosystems
- AI Agents & LLMs: OpenAI, LangChain, Qwen3, local inference; OCR, predictions
- IoT Development: ESP32, Raspberry Pi, Arduino, ESL; MQTT topologies
- Chat & Workflow Automation: WhatsApp Business API, Telegram Bot API
- Networking & Infra: MikroTik RouterOS, WireGuard VPN, NAT/DHCP, MQTT
- DevOps & Cloud: Docker Compose, GitHub Actions, PM2, Nginx, GCP/AWS/Azure
- DB Optimization: MySQL indexing, caching, profiling, replication; hybrid sync
- Security: JWT, OAuth2, HTTPS, SSL certs, access policies
...
- Implemented WhatsApp/Telegram automation for notifications and support chat.
- Dockerized local servers synced with GCP; established CI/CD pipelines.
...
- Improved performance via caching and modularization; supported 50+ clients.
...
Portfolio: [faztrick.com](https://faztrick.com)
